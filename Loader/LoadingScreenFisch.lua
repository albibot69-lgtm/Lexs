...
task.spawn(function()
    ...
    loadstring(game:HttpGet("https://raw.githubusercontent.com/albibot69-lgtm/Lexs/refs/heads/main/Loader/FischOnly.lua"))() -- replace with your loadstring
end)

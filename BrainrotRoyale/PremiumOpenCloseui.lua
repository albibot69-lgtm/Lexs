...
for _, name in ipairs(bannedExecutors) do
    if executor:lower():find(name:lower()) then
        warn("❌ Executor \"" .. executor .. "\" not supported by LexsHub.")
...
local success, WindUI = pcall(function()
	return loadstring(game:HttpGet("https://raw.githubusercontent.com/albibot69-lgtm/Lexs/refs/heads/main/BrainrotRoyale/Premium.lua"))()
end)
